...
| Q1–Q5 | Questions tranchées le 7 septembre 2026 ([etape-5a.md](etape-5a.md), « Réponses » ; [etape-5b.md](etape-5b.md)) | Profilée sans étiquette = 0 (Q1) ; groupe sans profil refusé (Q2) ; anciens prérequis ET condition sur la même source = refus, une seule représentation (Q3) ; aucune pertinence par contexte, étiquette sans profil = zéro contribution mais copies brutes comptées (Q4/Q5) |
