...
| Q1–Q5 | Questions tranchées le 7 septembre 2026 ([etape-5a.md](etape-5a.md), « Réponses » ; [etape-5b.md](etape-5b.md)) | Profilée sans étiquette = 0 (Q1, **inversée le 16 septembre 2026 sur décision** — [annotations par défaut](annotations-par-defaut.md), D14′ : le profil seul compte, cas Q1 révisé et oracle étendu ; profil « réactive » ajouté, N01) ; groupe sans profil refusé (Q2) ; anciens prérequis ET condition sur la même source = refus, une seule représentation (Q3) ; aucune pertinence par contexte, étiquette sans profil = zéro contribution mais copies brutes comptées (Q4/Q5) |
...
| 5. Chronologie et conditions | Comparaison exacte à l'oracle sur 5+pioche ; mêmes règles dans tous les consommateurs ; ET/OU testés | Livrée : partie A (moteur et oracles, [etape-5a.md](etape-5a.md)) et partie B (migration 002, interface, exports, [etape-5b.md](etape-5b.md)) |
