...
const SCRATCH = 'C:/Users/ccrepin/AppData/Local/Temp/claude/c--dev-Testhand/bcb8d50a-2cd4-45c2-a407-fa1d38dddc7d/scratchpad';
...
async function captureWidth({ w, h, mobile }) {
  ...
  await page.waitForTimeout(300);
  await page.locator('button[title="Second · 5 cartes + pioche"]').first().click();
  ...
  const tabs = [['Combos', 'combos'], ['Mur de mains', 'mains'], ['Inventaire', 'inventaire'], ['Plans de side', 'side']];
