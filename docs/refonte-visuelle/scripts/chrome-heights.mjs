...
for (const cfg of [{ w: 360, h: 780, mobile: true }, { w: 390, h: 844, mobile: true }, { w: 768, h: 1024, mobile: true }, { w: 1440, h: 900, mobile: false }]) {
  ...
  const m = await page.evaluate(() => {
    ...
    const tabs = [...document.querySelectorAll('nav button')].map((b) => ({ t: b.innerText, ...r(b) }));
...
await browser.close();
fs.writeFileSync('C:/Users/ccrepin/AppData/Local/Temp/claude/c--dev-Testhand/87a7b984-2e6e-486e-84fb-f9ecbb380ec9/scratchpad/audit/apres/chrome-heights.json', JSON.stringify(out, null, 1));
